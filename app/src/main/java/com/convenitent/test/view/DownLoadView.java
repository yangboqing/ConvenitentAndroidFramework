...
/**
 * Created by yangboqing on 2016/12/6.
 */
...
public class DownLoadView extends View {
    ...
    private static final int DEFAULT_STATUS = STATUS_PRE;
...
//                }
    ...
    public void reset() {
        if (mCurrentStatus != STATUS_RESET) {
            return;
        }
