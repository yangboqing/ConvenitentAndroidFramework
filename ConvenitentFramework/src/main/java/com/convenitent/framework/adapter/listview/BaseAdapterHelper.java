 ...
 *
 * Created by yangboqing on 16/8/23.
 */
public class BaseAdapterHelper {
    ...
    public static BaseAdapterHelper get(Context context, View convertView, ViewGroup parent, int layoutId, int position) {
        ...
        BaseAdapterHelper existHelper = (BaseAdapterHelper) convertView.getTag();
        existHelper.position = position;
        return existHelper;
    }
    ...
    protected <T extends View> T retrieveView(int viewId) {
        ...
        if (view == null) {
            view = ViewUtils.$(convertView,viewId);
